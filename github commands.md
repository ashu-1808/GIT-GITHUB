...
Here’s a **clean, practical GitHub (Git) cheat sheet** in a table format—similar to what you’ve been building for Linux commands. This is structured for **quick revision + interview prep**.
